...
- [x] Virtual file system properly resolves `..` paths, handles quoted commands like `echo "hello" > "a.txt"`, and prevents orphaned files when creating paths with slashes.
